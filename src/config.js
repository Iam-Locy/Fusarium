...
export default {
    ...
    scale: 1,
    skip: 10,
    seed: 1,//Math.floor(Math.random() * 100),
    statecolours: {
        colour: colourMap,
        pColour: colourMap,
        food: {
    ...
    chromosome_loss_rate: 0.01,  // Chance of losing a chromosome during sporulation
    relocation_rate: 0.01,//0.02,      // Chance of genes moving between compartments during sporulation
