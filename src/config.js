...
export default {
    ...
    fungus_uptake: 10,          // Amount of environmental resources aquired in 1 ts by a node of the hyphal network
    fungus_upkeep: 0.25,        // Amount of internal resources used in 1 ts by a node of the hyphal network
    ...
    plant_scale: 200,           // Scale of one cell on 
