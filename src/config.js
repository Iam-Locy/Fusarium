...
export default {
    ...
    scale: 1,
    skip: 10,
    seed: 10,//Math.floor(Math.random() * 100),
    statecolours: {
        colour: colourMap,
        pColour: colourMap,
        food: {
    ...
    fungus_upkeep: 0.00,         // Amount of internal resources used in 1 ts by a node of the hyphal network
    ...
    parasite_ratio: 0.33,        // Ratio og fungi with pathogenicity gene
    hgt_rate: 0.01,              // Chance of horizontal chromosome transfer (hgt) between connected fungal networks
    hgt_mode: "copy",           // Mode of hgt, it can be "copy" (copy-paste) or "cut" (cut&paste)
    gene_loss_rate: 0.0,             // Chance of losing a gene during sporulation
    gene_gain_rate: 0.0,             // Chance of gaining a gene during sporulation
    chromosome_loss_rate: 0.0,  // Chance of losing a chromosome during sporulation
