export default {
    ...
    fungus_uptake: 0.015,            // Amount of environmental resources aquired in 1 ts by a node of the hyphal network
    fungus_upkeep: 0.005,           // Amount of internal resources used in 1 ts by a node of the hyphal network
    phi: 10,                        // Multiplier for the uptake of parasitic nodes
